<?php
// Page de succès pour les paiements Barapay
...
<body>
    <div class="container">
        ...
        <p class="subtitle">Votre don a été traité avec succès</p>
        ...
        <a href="http://localhost:8000" class="btn" style="background: #6c757d;">
            Page d'accueil API
        </a>
    </div>
